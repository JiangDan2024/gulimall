...
{
    private String prefix = "coupon/smsSeckillPromotion";
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(SeckillPromotion seckillPromotion)
    {
        return seckillPromotionService.save(seckillPromotion)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap)
    {
        ...
        mmap.put("seckillPromotion", seckillPromotion);
        return prefix + "/edit";
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(SeckillPromotion seckillPromotion)
    {
        return seckillPromotionService.updateById(seckillPromotion)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
