 ...
 */
@Controller
@RequestMapping("/order/order_setting")
public class OrderSettingController extends BaseController
{
    private String prefix = "order/order_setting";

    @Autowired
    private IOrderSettingService orderSettingService;

    @GetMapping()
    public String order_setting()
    {
        return prefix + "/order_setting";
    }
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(OrderSetting orderSetting)
    {
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap)
    {
        ...
        mmap.put("orderSetting", orderSetting);
        return prefix + "/edit";
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(OrderSetting orderSetting)
    {
        return orderSettingService.updateById(orderSetting)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
