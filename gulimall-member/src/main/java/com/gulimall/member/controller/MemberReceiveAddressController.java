...
{
    private String prefix = "member/umsMemberReceiveAddress";
    ...
    public String address()
    {
        ...
        {
            startPage();
            List<MemberReceiveAddress> list = memberReceiveAddressService.list(
    ...
    {
        return memberReceiveAddressService.save(memberReceiveAddress)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
    ...
    {
        return memberReceiveAddressService.updateById(memberReceiveAddress)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
