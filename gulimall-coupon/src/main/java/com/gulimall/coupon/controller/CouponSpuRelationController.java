...
public class CouponSpuRelationController extends BaseController
{
    ...
    public TableDataInfo list(CouponSpuRelation couponSpuRelation)
    {
        ...
        Page<CouponSpuRelation> page = new Page<>(pageDomain.getPageNum(), pageDomain.getPageSize());
        QueryWrapper<CouponSpuRelation> wrapper = new QueryWrapper<>(couponSpuRelation);
        IPage<CouponSpuRelation> result = couponSpuRelationService.page(page, wrapper);
    ...
    {
        List<CouponSpuRelation> list = couponSpuRelationService.list(new QueryWrapper<>(couponSpuRelation));
    ...
    {
        return success(couponSpuRelationService.getById(id));
    }
    ...
    {
        return toAjax(couponSpuRelationService.save(couponSpuRelation));
    }
    ...
    {
        return toAjax(couponSpuRelationService.updateById(couponSpuRelation));
    }
    ...
    {
        return toAjax(couponSpuRelationService.removeByIds(ids));
    }
}