...
{
    private String prefix = "coupon/smsMemberPrice";
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(MemberPrice memberPrice)
    {
        return memberPriceService.save(memberPrice)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(MemberPrice memberPrice)
    {
        return memberPriceService.updateById(memberPrice)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
