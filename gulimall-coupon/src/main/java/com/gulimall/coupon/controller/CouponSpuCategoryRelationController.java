...
{
    private String prefix = "coupon/smsCouponSpuCategoryRelation";
    ...
    public String relation()
    {
        ...
        {
            startPage();
            List<CouponSpuCategoryRelation> list = couponSpuCategoryRelationService.list(
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(CouponSpuCategoryRelation couponSpuCategoryRelation)
    {
        return couponSpuCategoryRelationService.save(couponSpuCategoryRelation)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap)
    {
        ...
        mmap.put("couponSpuCategoryRelation", couponSpuCategoryRelation);
        return prefix + "/edit";
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(CouponSpuCategoryRelation couponSpuCategoryRelation)
    {
        return couponSpuCategoryRelationService.updateById(couponSpuCategoryRelation)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
