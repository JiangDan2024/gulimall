...
{
    private String prefix = "coupon/smsCouponHistory";
    ...
    public String history()
    {
        ...
        {
            startPage();
            List<CouponHistory> list = couponHistoryService.list(
    ...
    {
        return couponHistoryService.save(couponHistory)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
    ...
    {
        return couponHistoryService.updateById(couponHistory)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
