...
{
    private String prefix = "member/umsMemberLoginLog";
    ...
    public String log()
    {
        ...
        {
            startPage();
            List<MemberLoginLog> list = memberLoginLogService.list(
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(MemberLoginLog memberLoginLog)
    {
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap)
    {
        ...
        mmap.put("memberLoginLog", memberLoginLog);
        return prefix + "/edit";
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(MemberLoginLog memberLoginLog)
    {
