...
{
    private String prefix = "ware/wmsWareOrderTask";
    ...
    public String task()
    {
        ...
        {
            startPage();
            List<WareOrderTask> list = wareOrderTaskService.list(
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(WareOrderTask wareOrderTask)
    {
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap)
    {
        ...
        mmap.put("wareOrderTask", wareOrderTask);
        return prefix + "/edit";
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(WareOrderTask wareOrderTask)
    {
