...
{
    private String prefix = "coupon/smsSeckillSkuRelation";
    ...
    public String relation()
    {
        ...
        {
            startPage();
            List<SeckillSkuRelation> list = seckillSkuRelationService.list(
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(SeckillSkuRelation seckillSkuRelation)
    {
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap)
    {
        ...
        mmap.put("seckillSkuRelation", seckillSkuRelation);
        return prefix + "/edit";
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(SeckillSkuRelation seckillSkuRelation)
    {
        return seckillSkuRelationService.updateById(seckillSkuRelation)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
