...
{
    private String prefix = "coupon/smsCouponSpuRelation";
    ...
    public String relation()
    {
        ...
        {
            startPage();
            List<CouponSpuRelation> list = couponSpuRelationService.list(
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(CouponSpuRelation couponSpuRelation)
    {
        return couponSpuRelationService.save(couponSpuRelation)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
    ...
    public String edit(@PathVariable("id") Long id, ModelMap mmap)
    {
        ...
        mmap.put("couponSpuRelation", couponSpuRelation);
        return prefix + "/edit";
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(CouponSpuRelation couponSpuRelation)
    {
        return couponSpuRelationService.updateById(couponSpuRelation)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
