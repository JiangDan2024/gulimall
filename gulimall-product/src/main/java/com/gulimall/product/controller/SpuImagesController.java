...
{
    private String prefix = "product/pmsSpuImages";
    ...
    public String images()
    {
        ...
        {
            startPage();
            List<SpuImages> list = spuImagesService.list(
    ...
    @PostMapping("/add")
    @ResponseBody
    public AjaxResult addSave(SpuImages spuImages)
    {
        return spuImagesService.save(spuImages)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
    ...
    @PostMapping("/edit")
    @ResponseBody
    public AjaxResult editSave(SpuImages spuImages)
    {
        return spuImagesService.updateById(spuImages)
                ? AjaxResult.success()
                : AjaxResult.error();
    }
        ...
        {
            return spuImagesService.removeByIds(ids)
                    ? AjaxResult.success()
                    : AjaxResult.error();
        }
}