...
public class CouponHistoryController extends BaseController
{
    ...
    public TableDataInfo list(CouponHistory couponHistory)
    {
        ...
        Page<CouponHistory> page = new Page<>(pageDomain.getPageNum(), pageDomain.getPageSize());
        QueryWrapper<CouponHistory> wrapper = new QueryWrapper<>(couponHistory);
        IPage<CouponHistory> result = couponHistoryService.page(page, wrapper);
    ...
    {
        List<CouponHistory> list = couponHistoryService.list(new QueryWrapper<>(couponHistory));
    ...
    {
        return success(couponHistoryService.getById(id));
    }
    ...
    {
        return toAjax(couponHistoryService.save(couponHistory));
    }
    ...
    {
        return toAjax(couponHistoryService.updateById(couponHistory));
    }
    ...
    {
        return toAjax(couponHistoryService.removeByIds(ids));
    }
}